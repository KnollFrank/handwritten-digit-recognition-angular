...
import { KnnWorkersService } from '../knn/knn-workers.service';
...
export class KnnBuilderComponent implements OnInit {
  ...
  constructor(
    ...
    private knnWorkersService: KnnWorkersService) { }

  ngOnInit() {
  }

  onSubmit() {
    this.buildKnnClassifier(this.knnWorkersService.knnWorkers);
  }
